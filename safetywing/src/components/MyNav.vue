    ...
    <div class="nav">
        ...
        >
            <div class="menu-img menu-affairs">
                <svg 
                    ...
                    height="30"
                >
                    <path v-bind:fill="this.$color" d="M928.3 920.3H98c-17.7 0-32-14.3-32-32V416.8c0-14.5 9.8-27.2 23.8-30.9 14-3.7 28.8 2.5 36 15.2C195 523 370.8 548.6 506.1 548.6c97.6 0 184.4-14.9 250.8-43 69.9-29.6 117.7-73.3 142-129.8 6-14 21-21.8 35.9-18.7 14.9 3.1 25.5 16.2 25.5 31.3v499.9c0 17.7-14.3 32-32 32z m-798.3-64h766.3v-366c-3 3-6.1 5.9-9.2 8.7-28.9 26.1-64.3 48.1-105.2 65.5-75.3 31.9-168.1 48.1-275.8 48.1-101.1 0-188-13.1-258.2-38.9-46.5-17.1-85.9-39.8-117.9-67.9v350.5z">
                    </path>
                    <path v-bind:fill="this.$color" d="M130 416.8H66V260.6c0-17.7 14.3-32 32-32h830.3c17.7 0 32 14.3 32 32v127.8h-64v-95.8H130v124.2zM508.5 674.1c-17.7 0-32-14.3-32-32V509c0-17.7 14.3-32 32-32s32 14.3 32 32v133c0 17.8-14.3 32.1-32 32.1z">
                    </path>
                    <path v-bind:fill="this.$color" d="M692.1 292.6H331c-24.3 0-44-19.7-44-44v-105c0-24.3 19.7-44 44-44h361.1c24.3 0 44 19.7 44 44v105c0 24.3-19.7 44-44 44z m-341.1-64h321.1v-65H351v65z">
                    </path>
                </svg>
            </div>
        ...
        >
            <div class="menu-img menu-admin">
                <svg t="1550894311750" style="" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="864" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="30">
                    <path v-bind:fill="this.$color" d="M512 568.888889c-159.288889 0-284.444444-125.155556-284.444444-284.444445s125.155556-284.444444 284.444444-284.444444 284.444444 125.155556 284.444444 284.444444-125.155556 284.444444-284.444444 284.444445z m0-56.888889c125.155556 0 227.555556-102.4 227.555556-227.555556s-102.4-227.555556-227.555556-227.555555-227.555556 102.4-227.555556 227.555555 102.4 227.555556 227.555556 227.555556zM824.888889 1024c-79.644444 0-142.222222-62.577778-142.222222-142.222222s62.577778-142.222222 142.222222-142.222222 142.222222 62.577778 142.222222 142.222222-62.577778 142.222222-142.222222 142.222222z m0-56.888889c45.511111 0 85.333333-39.822222 85.333333-85.333333s-39.822222-85.333333-85.333333-85.333334-85.333333 39.822222-85.333333 85.333334 39.822222 85.333333 85.333333 85.333333z"></path>
                    <path v-bind:fill="this.$color" d="M796.444444 455.111111h56.888889v284.444445h-56.888889zM853.333333 455.111111h113.777778v56.888889h-113.777778zM853.333333 568.888889h113.777778v56.888889h-113.777778z"></path>
                    <path v-bind:fill="this.$color" d="M512 512l-51.2 62.577778C261.688889 597.333333 113.777778 762.311111 113.777778 967.111111H56.888889v-56.888889h5.688889c28.444444-221.866667 216.177778-398.222222 449.422222-398.222222z m0 0l-51.2 62.577778C261.688889 597.333333 113.777778 762.311111 113.777778 967.111111H56.888889v-56.888889h5.688889c28.444444-221.866667 216.177778-398.222222 449.422222-398.222222z"></path>
                </svg>
            </div>
            ...
            <div class="color-selector" :style="{ border:'1px solid '+this.$color }">
                ...
                <div>
                    ...
                    <li>
                        ...
                        <div :style="{ display:'none' }"><input type="color" v-bind:value="this.$color" @change="customChgColor($event)"></div>
                    </li>
                </div>
            </div>
        </li>
        ...
        <li class="login">
            <div class="login-true" v-show="logined" @mouseenter="getRealname">
                ...
                <div class="logined-dropmenu" :style="{ border:'1px solid '+this.$color }">
                    <div class="dropmenu-detail" v-text="'你好, ' + realname" :style="{ color:this.$color }" @mouseenter="hoverDropMenu($event)" @mouseleave="unHoverDropMenu($event)"></div>
                    <div class="dropmenu-detail" :style="{ color:this.$color }" @mouseenter="hoverDropMenu($event)" @mouseleave="unHoverDropMenu($event)">我的信息</div>
                    <div class="dropmenu-detail" :style="{ color:this.$color }" @mouseenter="hoverDropMenu($event)" @mouseleave="unHoverDropMenu($event)">修改密码</div>
                    <div class="dropmenu-detail" @click="logoff" :style="{ color:this.$color }" @mouseenter="hoverDropMenu($event)" @mouseleave="unHoverDropMenu($event)">退出登录</div>
                </div>
            </div>
            <div class="login-false" v-show="!logined" @click="meetUrl('/login');">
                <div v-bind:style="{ border:'2px solid ' + this.$color }">
...
export default {
    ...
    methods: {
        ...
        borderMenu: function(e) {
            e.target.style.border = "2px solid " + this.$color;
            e.target.children[1].style.color = this.$color;
        },
