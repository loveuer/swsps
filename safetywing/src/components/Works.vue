                            ...
                            <div class="malfs-one" v-for="(malf, index) of this.$store.state.todayMessage.malf.malfs" :key="index">
                                <el-card>
                                    ...
                                    <div class="mone-content">
                                        <div v-html="malf.content"></div>
                                    </div>
                                    <div class="mone-commits">
                                        <div v-show="!malf.last2commits" class="mone-onecommit">暂无添加</div>
                                        <div v-show="malf.last2commits">
                                            <div class="mone-onecommit">
                                                ．．．．．．
                                            </div>
                                            <div v-for="(c, ci) of malf.last2commits" :key="ci">
                                                <div class="mone-onecommit"><font style="width:155px;">{{ c.time }}</font><font style="width:60px;">{{ c.auth }}</font><span v-html="c.content"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </el-card>
...
export default {
    ...
    mounted() {
        ...
        let newtraininglist = [
            ...
            {date:'2019-03-27',sim:'5989',airline:'西藏航空',session:5,ts:'21:00',te:'01:00',ta:4,instructor:'xxxxxx',students:'yyyyyy, zzzzzz',mode:'',crew:'19F320XNRC0000',auth:'刘博强',img:'/static/img/tlist/mock3.jpg'},
        ];
